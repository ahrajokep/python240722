...
class Window(QMainWindow, form_class):
    def __init__(self):
        ...
        #탭키로 네비게이션 금지 
        self.tableWidget.setTabKeyNavigation(False) # True로 Tabkey로 다음입력값 이동 가능
        ...
        # 시그널 returnPressed 발생하면(Enter키) 다음 칸으로 커서 이동  -----> 코드로 시그널과 슬롯메서드 미리 연결함
        #더블클릭 시그널 처리
